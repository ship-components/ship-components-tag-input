...
var _pluck = __webpack_require__(107);
...
var _TagContainer = __webpack_require__(101);
...
var TagInput = function (_React$Component) {
  ...
  function TagInput() {
    ...
    _this.state = {
      selection: new _immutable2.default.List()
    };
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(44)(Function.call, __webpack_require__(54).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _shipComponentsUtility = __webpack_require__(105);

var _shipComponentsIcon = __webpack_require__(58);
...
var _TagContainer = __webpack_require__(122);
...
var TagContainer = function (_React$Component) {
  ...
  TagContainer.prototype.getVisibleOptions = function getVisibleOptions(filterText) {
    ...
    if (!this.isEmpty()) {
      if (this.props.selection instanceof _immutable2.default.List) {
  ...
  TagContainer.prototype.isEmpty = function isEmpty() {
    ...
    if (props.selection instanceof _immutable2.default.List) {
...
TagContainer.propTypes = {
  ...
  options: _propTypes2.default.array.isRequired,
  selection: _propTypes2.default.instanceOf(_immutable2.default.List).isRequired,
...
var _strings = __webpack_require__(106);
...
var _parseUrl = __webpack_require__(110);

var _parseUrl2 = _interopRequireDefault(_parseUrl);

var _NativeFileUploadDialog = __webpack_require__(111);

var _NativeFileUploadDialog2 = _interopRequireDefault(_NativeFileUploadDialog);

var _KeyEvents = __webpack_require__(112);
...
var _is = __webpack_require__(56);
...
var _getIn = __webpack_require__(57);
...
var _getIn2 = __webpack_require__(57);
...
var _Controls = __webpack_require__(121);
...
var SelectControls = function (_React$Component) {
  ...
  SelectControls.prototype.filterHtml = function filterHtml() {
    return this.props.filterable ? _react2.default.createElement('input', {
      ...
      }, _Controls2.default.withTags, this.props.selection.size > 0)),
      type: 'text'
    }) : null;
  };
  ...
  SelectControls.prototype.selectionDisplayHtml = function selectionDisplayHtml() {
    ...
    }, this.props.selection ? this.props.selection.get(this.props.orderOptionsBy) : this.props.label), this.filterHtml.call(this));
  };
...
var Tag = function (_React$Component) {
  ...
  Tag.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    ...
    var propsToCheck = ['className', 'title'];
    return propsToCheck.some(function (field) {
      return _this2.props[field] !== nextProps[field];
    });
  };
